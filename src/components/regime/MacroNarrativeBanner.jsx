/**
 * MacroNarrativeBanner — dismissible alert banner showing FactorWatch signals.
 *
 * Displays when isShakeout or isJunkRally is true, providing actionable
 * narrative context for the current market regime.
 *
...
export default function MacroNarrativeBanner() {
  ...
  // Only show if at least one signal is active
  if (!signals.isShakeout && !signals.isJunkRally) return null;
